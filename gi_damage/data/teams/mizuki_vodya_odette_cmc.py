...
MIZUKI = Character(
    ...
    sources=(
        ...
        stellar_swirl("Навык — звёздное рассеивание (МС)", "em", 10.0, "anemo",
                      [occ(1, ON, DREAM, BREEZEBORNE, FROSTGLOW, VODYA_LEAD), occ(2, ON, INST, DREAM, FROSTGLOW, BREEZEBORNE, VODYA_LEAD),occ(1, ON, BREEZEBORNE, FROSTGLOW, VODYA_LEAD)],
        ...
        1: Constellation(
            ...
            sources=(
                stellar_swirl("C1: доп. звёздное рассеивание (МС)", "em", 4.0,
                              "anemo", [occ(1, ON, DREAM, VODYA_LEAD, BREEZEBORNE, FROSTGLOW), occ(2, ON, INST, DREAM, VODYA_LEAD, BREEZEBORNE, FROSTGLOW)]),
...
ALL = {c.name: c for c in (MIZUKI, CRYO_MC, ODETTE, VODYANITSA)}
